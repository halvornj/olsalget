...
export class Coordinate {
    readonly lat: number; //double
    readonly lon: number; //double
...
export class CacheData {
    ...
    constructor(kommunenavn: string, position: Coordinate) {
...
export class Holiday {
    ...
    public static fromObject(obj: Object): Holiday {
...
export class Municipality {
    ...
    */
    ...
    public static fromObject(obj: Object): Municipality {
        const r = new Municipality(
            "",
            null,
            null,
            null,
    ...
    */
    getStringForDate(date: Date, holidays: Array<Holiday>): string {
        if (date.getDay() === 0) {
            return "stengt";
        }
